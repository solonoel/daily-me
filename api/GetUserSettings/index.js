...
module.exports = async function(context, req) {
  try {
    ...
    const settingResult = await pool.request()
      ...
      .query(`SELECT RecencyDays, MaxHeadlines, YouTubeMaxResults, OtherHeadlinesPerKeyword, FetchHour, DisableYoutubeToday FROM [HeadlineSetting] WHERE UserID = @UserID`);
